...
export const I18nModule = {
    ...
    dictionary: {
        ru: {
            ...
            'cat_clothes_other': 'Другое', 'cat_kids_school': 'Школьные товары', 'cat_kids_other': 'Другое', 'cat_office_eq': 'Оргтехника', 'cat_smarthome': 'Умный дом', 'cat_electro_other': 'Другое', 'cat_plants': 'Растения', 'cat_lighting': 'Освещение', 'cat_interior_other': 'Другое', 'cat_special': 'Спецтехника', 'cat_water': 'Водный транспорт', 'cat_transport_other': 'Другое', 'cat_medical': 'Мед. изделия', 'cat_beauty_other': 'Другое', 'cat_srv_it': 'IT и дизайн', 'cat_srv_move': 'Перевозки', 'cat_srv_other': 'Другое', 'cat_job_part': 'Подработка', 'cat_job_other': 'Другое', 'cat_biz_other': 'Другое', 'cat_tickets_travel': 'Билеты и путешествия', 'cat_hunt': 'Охота и рыбалка', 'cat_hobby_other': 'Другое', 'cat_pet_breed': 'Вязка',
            'Школа': 'Школа', 'Школьные товары': 'Школьные товары', 'Оргтехника': 'Оргтехника', 'Умный дом': 'Умный дом', 'Растения': 'Растения', 'Освещение': 'Освещение', 'Спецтехника': 'Спецтехника', 'Водный': 'Водный', 'Водный транспорт': 'Водный транспорт', 'Медицина': 'Медицина', 'Мед. изделия': 'Мед. изделия', 'IT': 'IT', 'IT и дизайн': 'IT и дизайн', 'Перевозки': 'Перевозки', 'Подработка': 'Подработка', 'Билеты и путешествия': 'Билеты и путешествия', 'Охота': 'Охота', 'Охота и рыбалка': 'Охота и рыбалка', 'Вязка': 'Вязка',
            'vip_bumps_title': 'VIP-поднятия', "vip_empty_title": "Место в ТОПе<br>свободно",
            "vip_empty_desc": "Твой товар увидят<br>тысячи покупателей",
            "vip_empty_btn": "Занять место",
            'sort_new': 'Сначала новые',
            'sort_cheap': 'Сначала дешевые',
            'sort_exp': 'Сначала дорогие',
            ...
            'filter_btn': 'Фильтры', 'filter_cat': 'Категория', 'filter_city': 'Город',
            ...
            'item_address': 'Точный адрес:', 'btn_chat': 'Чат', 'btn_bump': 'Поднять', 'btn_bump_sub': 'Раз в 24 часа', 'filter_condition': 'Состояние',
            ...
            'btn_edit_profile': 'Редактировать профиль', 'your_rating': 'Ваш рейтинг', 'tab_my_reviews': 'Мои отзывы', 'tokens_unit': 'шт.',
            'pro_active_days': 'PRO (Активен еще {days} дн.)', 'add_to_saved': 'Добавить на склад', 'remove_from_saved': 'Убрать со склада',
            'share_item': 'Поделиться товаром', 'remove_from_vip': 'Убрать из VIP', 'to_vip_block_7_days': 'В VIP-блок (7 дней)',
            ...
            'vip_bumps': 'Пакеты поднятий', 'room_1': '1 комната', 'room_1_5': '1.5 комнаты', 'room_2': '2 комнаты', 'room_2_5': '2.5 комнаты', 'room_3': '3 комнаты', 'room_4_plus': '4 и более',
            'tokens_desc': 'Используйте токены, чтобы закреплять ваши товары в VIP-блоке на 7 дней.',
            'tokens_word': 'токенов', 'city_belgrade': 'Белград', 'city_novisad': 'Нови-Сад', 'city_nis': 'Ниш', 'city_kragujevac': 'Крагуевац', 'city_subotica': 'Суботица', 'city_zrenjanin': 'Зренянин', 'city_pancevo': 'Панчево', 'city_cacak': 'Чачак', 'city_kraljevo': 'Кралево', 'city_novipazar': 'Нови-Пазар', 'city_smederevo': 'Смедерево', 'city_leskovac': 'Лесковац', 'city_vranje': 'Вране', 'city_sombor': 'Сомбор', 'city_other': 'Другой',
            'cat_gr_clothes': 'Одежда и Обувь', 'cat_w': 'Женская', 'cat_m': 'Мужская', 'cat_shoes': 'Обувь', 'cat_bags': 'Сумки', 'cat_acc': 'Аксессуары', 'cat_work': 'Спецодежда',
            'cat_gr_kids': 'Детям', 'cat_toys': 'Игрушки', 'cat_stroll': 'Коляски', 'cat_kids_cl': 'Одежда', 'cat_kids_sh': 'Обувь', 'cat_kids_car': 'Автокресла', 'cat_kids_furn': 'Детская мебель',
            'tokens_single': 'Поштучно',
            'tokens_save': 'Выгода 20%',
            'tokens_hit': 'Хит продаж',
            'tokens_biz': 'Для бизнеса',
            ...
            'btn_buy_more': 'Докупить',
            'Активен еще': 'Активен еще', 'дн.': 'дн.', 'Способ получения': 'Способ получения', 'Варианты оплаты': 'Варианты оплаты', 'СЕРБИЯ': 'СЕРБИЯ', 'Криптовалюта': 'Криптовалюта'
        },
        en: {
            ...
            'cat_clothes_other': 'Other', 'cat_kids_school': 'School Supplies', 'cat_kids_other': 'Other', 'cat_office_eq': 'Office Equipment', 'cat_smarthome': 'Smart Home', 'cat_electro_other': 'Other', 'cat_plants': 'Plants', 'cat_lighting': 'Lighting', 'cat_interior_other': 'Other', 'cat_special': 'Special Vehicles', 'cat_water': 'Watercraft', 'cat_transport_other': 'Other', 'cat_medical': 'Medical Supplies', 'cat_beauty_other': 'Other', 'cat_srv_it': 'IT & Design', 'cat_srv_move': 'Moving & Delivery', 'cat_srv_other': 'Other', 'cat_job_part': 'Part-time / Gigs', 'cat_job_other': 'Other', 'cat_biz_other': 'Other', 'cat_tickets_travel': 'Tickets & Travel', 'cat_hunt': 'Hunting & Fishing', 'cat_hobby_other': 'Other', 'cat_pet_breed': 'Breeding',
            'Школа': 'School', 'Школьные товары': 'School Supplies', 'Оргтехника': 'Office Equipment', 'Умный дом': 'Smart Home', 'Растения': 'Plants', 'Освещение': 'Lighting', 'Спецтехника': 'Special Vehicles', 'Водный': 'Watercraft', 'Водный транспорт': 'Watercraft', 'Медицина': 'Medical', 'Мед. изделия': 'Medical Supplies', 'IT': 'IT', 'IT и дизайн': 'IT & Design', 'Перевозки': 'Moving', 'Подработка': 'Part-time', 'Билеты и путешествия': 'Tickets & Travel', 'Охота': 'Hunting', 'Охота и рыбалка': 'Hunting & Fishing', 'Вязка': 'Breeding',
            'crypto_warning_title': 'Important: Paying from Exchanges', 'city_belgrade': 'Belgrade', 'city_novisad': 'Novi Sad', 'city_nis': 'Niš', 'city_kragujevac': 'Kragujevac', 'city_subotica': 'Subotica', 'city_zrenjanin': 'Zrenjanin', 'city_pancevo': 'Pančevo', 'city_cacak': 'Čačak', 'city_kraljevo': 'Kraljevo', 'city_novipazar': 'Novi Pazar', 'city_smederevo': 'Smederevo', 'city_leskovac': 'Leskovac', 'city_vranje': 'Vranje', 'city_sombor': 'Sombor', 'city_other': 'Other',
            'cat_gr_clothes': 'Clothing & Shoes', 'cat_w': 'Women\'s', 'cat_m': 'Men\'s', 'cat_shoes': 'Shoes', 'cat_bags': 'Bags', 'cat_acc': 'Accessories', 'cat_work': 'Workwear',
            'cat_gr_kids': 'For Kids', 'cat_toys': 'Toys', 'cat_stroll': 'Strollers', 'cat_kids_cl': 'Clothes', 'cat_kids_sh': 'Shoes', 'cat_kids_car': 'Car seats', 'cat_kids_furn': 'Furniture',
            'add_type_product': 'Sell an item', "vip_empty_title": "TOP spot<br>available",
            "vip_empty_desc": "Thousands of buyers<br>will see your item",
            "vip_empty_btn": "Take the spot",
            ...
            'sort_exp': 'Most expensive',
            'sort_popular': 'Most popular',
            'Новое': 'New',
            'Б/У': 'Used', 'room_1': '1 room', 'room_1_5': '1.5 rooms', 'room_2': '2 rooms', 'room_2_5': '2.5 rooms', 'room_3': '3 rooms', 'room_4_plus': '4 or more',
            ...
            'add_address_title': 'Exact address and location', 'add_address_ph': 'Street and house number...',
            ...
            'del_post': 'PostExpress', 'report_title': 'Report', 'rep_fraud': 'Fraud / Deception',
            ...
            'pro_secure_label': 'Secure cryptocurrency payment', 'pro_pay_btn': 'PAY', 'btn_edit_profile': 'Edit Profile',
            'your_rating': 'Your rating', 'tab_my_reviews': 'My Reviews', 'pro_active_days': 'PRO (Active for {days} days)', 'tokens_unit': 'pcs.',
            'add_to_saved': 'Add to saved', 'remove_from_saved': 'Remove from saved', 'share_item': 'Share item',
            'remove_from_vip': 'Remove from VIP', 'to_vip_block_7_days': 'To VIP block (7 days)',
            ...
            'Статус':'Status', 'Любое':'Any', 'Новые находки':'New Finds',
            'Категория...':'Category...', 'Город...':'City...', 'Описание отсутствует.':'No description.',
            'Все категории': 'All Categories', 'Любая': 'Any', 'Динары': 'Dinars', 'Евро': 'Euros', 'Все в': 'All in',
            ...
            'faq_q2_1': 'All about', 'faq_q2_2': 'promotion', 'faq_q2_3': 'and TOP statuses',
            'faq_a2_sub': 'How to sell faster and more efficiently', 'faq_bump_title': 'Bump and VIP status',
            ...
            'faq_attn_title': 'Maximum attention', 'faq_attn_desc': 'Items with VIP status collect <strong>5–10 times more views</strong>. The item is always in sight of buyers, which guarantees a flurry of messages in the chat and a quick sale.',
            'faq_rot_title': 'Fair rotation', 'faq_rot_desc': 'The algorithm uses <strong>dynamic shuffling</strong>. With each page refresh, TOP items swap places. Every seller gets their fair share of attention!',
            'faq_act_title': 'Instant activation', 'faq_act_desc': 'Go to your profile and click the <strong>"Buy PRO"</strong> button. Choose a suitable token package and pay in 1 click. The system will credit the promotion to your account instantly.',
        ...
        sr: {
            ...
            'cat_clothes_other': 'Ostalo', 'cat_kids_school': 'Školski pribor', 'cat_kids_other': 'Ostalo', 'cat_office_eq': 'Kancelarijska oprema', 'cat_smarthome': 'Pametna kuća', 'cat_electro_other': 'Ostalo', 'cat_plants': 'Biljke', 'cat_lighting': 'Rasveta', 'cat_interior_other': 'Ostalo', 'cat_special': 'Specijalna vozila', 'cat_water': 'Plovila', 'cat_transport_other': 'Ostalo', 'cat_medical': 'Medicinska oprema', 'cat_beauty_other': 'Ostalo', 'cat_srv_it': 'IT i dizajn', 'cat_srv_move': 'Selidbe i transport', 'cat_srv_other': 'Ostalo', 'cat_job_part': 'Dodatni posao', 'cat_job_other': 'Ostalo', 'cat_biz_other': 'Ostalo', 'cat_tickets_travel': 'Karte i putovanja', 'cat_hunt': 'Lov i ribolov', 'cat_hobby_other': 'Ostalo', 'cat_pet_breed': 'Parenje',
            'Школа': 'Škola', 'Школьные товары': 'Školski pribor', 'Оргтехника': 'Kancelarijska oprema', 'Умный дом': 'Pametna kuća', 'Растения': 'Biljke', 'Освещение': 'Rasveta', 'Спецтехника': 'Specijalna vozila', 'Водный': 'Plovila', 'Водный транспорт': 'Plovila', 'Медицина': 'Medicina', 'Мед. изделия': 'Medicinska oprema', 'IT': 'IT', 'IT и дизайн': 'IT i dizajn', 'Перевозки': 'Selidbe', 'Подработка': 'Dodatni posao', 'Билеты и путешествия': 'Karte i putovanja', 'Охота': 'Lov', 'Охота и рыбалка': 'Lov i ribolov', 'Вязка': 'Parenje',
            'crypto_warning_title': 'Važno: Plaćanje sa menjačnica', 'city_belgrade': 'Beograd', 'city_novisad': 'Novi Sad', 'city_nis': 'Niš', 'city_kragujevac': 'Kragujevac', 'city_subotica': 'Subotica', 'city_zrenjanin': 'Zrenjanin', 'city_pancevo': 'Pančevo', 'city_cacak': 'Čačak', 'city_kraljevo': 'Kraljevo', 'city_novipazar': 'Novi Pazar', 'city_smederevo': 'Smederevo', 'city_leskovac': 'Leskovac', 'city_vranje': 'Vranje', 'city_sombor': 'Sombor', 'city_other': 'Drugo',
            'cat_gr_clothes': 'Odeća i Obuća', 'cat_w': 'Ženska', 'cat_m': 'Muška', 'cat_shoes': 'Obuća', 'cat_bags': 'Torbe', 'cat_acc': 'Aksesoari', 'cat_work': 'Radna odeća',
            'cat_gr_kids': 'Za decu', 'cat_toys': 'Igračke', 'cat_stroll': 'Kolica', 'cat_kids_cl': 'Odeća', 'cat_kids_sh': 'Obuća', 'cat_kids_car': 'Auto sedišta', 'cat_kids_furn': 'Nameštaj',
            'add_type_product': 'Prodaj predmet', "vip_empty_title": "TOP mesto<br>je slobodno",
            "vip_empty_desc": "Tvoj oglas će videti<br>hiljade kupaca",
            "vip_empty_btn": "Zauzmi mesto",
            ...
            'Состояние': 'Stanje',
            'sort_new': 'Prvo najnovije',
            'sort_cheap': 'Prvo najjeftinije',
            'sort_exp': 'Prvo najskuplje',
            'sort_popular': 'Po popularnosti',
            'Новое': 'Novo',
            'Б/У': 'Polovno', 'room_1': '1 soba', 'room_1_5': '1.5 soba', 'room_2': '2 sobe', 'room_2_5': '2.5 sobe', 'room_3': '3 sobe', 'room_4_plus': '4 i više',
            ...
            'add_address_title': 'Tačna adresa i lokacija', 'add_address_ph': 'Ulica i kućni broj...',
            ...
            'del_post': 'PostExpress', 'report_title': 'Žalba', 'rep_fraud': 'Prevara',
            ...
            'btn_edit_profile': 'Uredi profil', 'your_rating': 'Vaša ocena', 'tab_my_reviews': 'Moje recenzije', 'tokens_unit': 'kom.',
            'pro_active_days': 'PRO (Aktivan još {days} dana)', 'add_to_saved': 'Dodaj u sačuvano', 'remove_from_saved': 'Ukloni iz sačuvanog',
            'share_item': 'Podeli oglas', 'remove_from_vip': 'Ukloni iz VIP-a', 'to_vip_block_7_days': 'U VIP blok (7 dana)',
            ...
            'Электроника': 'Elektronika', 'Телефоны': 'Telefoni', 'Смартфоны': 'Pametni telefoni', 'ПК': 'PC', 'Компьютеры / PC': 'Računari / PC', 'Ноутбуки': 'Laptopovi', 'Планшеты': 'Tableti', 'ТВ': 'TV', 'ТВ и Видео': 'TV i Video', 'Аудио': 'Audio', 'Консоли': 'Konzole', 'Игры / Консоли': 'Igre / Konzole', 'Бытовая': 'Aparati', 'Бытовая техника': 'Bela tehnika', 'Фото': 'Foto', 'Фототехника': 'Foto oprema',
