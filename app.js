...
window.i18n = {
    ru: {
        ...
        'nav_profile': 'Профиль', 'nav_messages': 'Сообщения', 'nav_logout': 'Выйти', 'bot_nav_home': 'Главная',
        'bot_nav_saved': 'Склад', 'bot_nav_chat': 'Чат', 'feed_title': 'Находки', 'feed_desc': 'Самые свежие объявления Сербии',
...
window.switchSellerTab = (tabName) => {
    ...
    const searchInput = document.getElementById('seller-search-container');
