...
window.openModal = async id => {
    ...
    if (el) {
        ...
        if (id === 'profile-modal' && window.currentUser) {
            // Фиксируем высоту обеих плашек экономики...
            ...
            if (typeof window.renderProfileTabs === 'function') {
...
window.subcategoriesMap = {
    'Одежда': [{ val: 'Женская' }, { val: 'Мужская' }, { val: 'Обувь' }, { val: 'Сумки' }, { val: 'Аксессуары' }, { val: 'Спецодежда' }, { val: 'Другое' }],
    'Детям': [{ val: 'Игрушки' }, { val: 'Коляски' }, { val: 'Одежда' }, { val: 'Обувь' }, { val: 'Автокресла' }, { val: 'Мебель', label: 'Детская мебель' }, { val: 'Школа', label: 'Школьные товары' }, { val: 'Другое' }],
    'Электроника': [{ val: 'Телефоны', label: 'Смартфоны' }, { val: 'ПК', label: 'Компьютеры / ПК' }, { val: 'Ноутбуки' }, { val: 'Планшеты' }, { val: 'ТВ', label: 'ТВ и Видео' }, { val: 'Аудио' }, { val: 'Консоли', label: 'Игры / Консоли' }, { val: 'Бытовая', label: 'Бытовая техника' }, { val: 'Фото', label: 'Фототехника' }, { val: 'Оргтехника' }, { val: 'Умный дом' }, { val: 'Другое' }],
    'Интерьер': [{ val: 'Мебель' }, { val: 'Декор' }, { val: 'Посуда' }, { val: 'Текстиль' }, { val: 'Ремонт', label: 'Стройматериалы' }, { val: 'Инструменты' }, { val: 'Сад', label: 'Сад и Огород' }, { val: 'Растения' }, { val: 'Освещение' }, { val: 'Другое' }],
    'Транспорт': [{ val: 'Авто', label: 'Автомобили' }, { val: 'Мото' }, { val: 'Вело', label: 'Велосипеды' }, { val: 'Самокаты' }, { val: 'Запчасти' }, { val: 'Шины', label: 'Шины и диски' }, { val: 'Спецтехника' }, { val: 'Водный', label: 'Водный транспорт' }, { val: 'Другое' }],
    'Красота': [{ val: 'Косметика' }, { val: 'Парфюмерия' }, { val: 'Уход', label: 'Уход за собой' }, { val: 'Приборы', label: 'Фены и стайлеры' }, { val: 'Медицина', label: 'Мед. изделия' }, { val: 'Другое' }],
    'Услуги': [{ val: 'Ремонт', label: 'Ремонт техники' }, { val: 'Автосервис' }, { val: 'Стройка', label: 'Ремонт и стройка' }, { val: 'Красота', label: 'Бьюти услуги' }, { val: 'Репетиторы' }, { val: 'Праздники' }, { val: 'IT', label: 'IT и дизайн' }, { val: 'Перевозки' }, { val: 'Другое' }],
    'Работа': [{ val: 'Вакансии' }, { val: 'Резюме', label: 'Ищу работу' }, { val: 'Подработка' }, { val: 'Другое' }],
    'Бизнес': [{ val: 'Оборудование' }, { val: 'Бизнес', label: 'Готовый бизнес' }, { val: 'Сырье', label: 'Сырье и материалы' }, { val: 'Другое' }],
    'Хобби': [{ val: 'Спорт' }, { val: 'Туризм', label: 'Туризм и палатки' }, { val: 'Книги' }, { val: 'Музыка', label: 'Музыкальные инструменты' }, { val: 'Игры', label: 'Настольные игры' }, { val: 'Коллекции', label: 'Коллекционирование' }, { val: 'Билеты', label: 'Билеты и путешествия' }, { val: 'Охота', label: 'Охота и рыбалка' }, { val: 'Другое' }],
    'Животные': [{ val: 'Собаки' }, { val: 'Кошки' }, { val: 'Птицы' }, { val: 'Аквариум', label: 'Аквариумистика' }, { val: 'Товары', label: 'Зоотовары' }, { val: 'Вязка' }, { val: 'Другое' }],
